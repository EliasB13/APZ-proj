...
namespace APZ_BACKEND.Migrations
{
    ...
    [Migration("20191101150704_db_init")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APZ_BACKEND.Entities.BusinessUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APZ_BACKEND.Entities.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APZ_BACKEND.Entities.EmployeeRoleItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APZ_BACKEND.Entities.EmployeesRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APZ_BACKEND.Entities.ItemTaking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APZ_BACKEND.Entities.ItemTakingLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APZ_BACKEND.Entities.PrivateUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APZ_BACKEND.Entities.SharedItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("APZ_BACKEND.Entities.Employee", b =>
                {
                    b.HasOne("APZ_BACKEND.Entities.BusinessUser", "BusinessUser")
                        .WithMany("Employees")
                        .HasForeignKey("BusinessUserId");

                    b.HasOne("APZ_BACKEND.Entities.EmployeesRole", "EmployeesRole")
                        .WithMany("Employees")
                        .HasForeignKey("EmployeesRoleId");

                    b.HasOne("APZ_BACKEND.Entities.PrivateUser", "PrivateUser")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("APZ_BACKEND.Entities.EmployeeRoleItem", b =>
                {
                    ...
                    b.HasOne("APZ_BACKEND.Entities.SharedItem", "SharedItem")
            ...
            modelBuilder.Entity("APZ_BACKEND.Entities.ItemTakingLine", b =>
                {
                    b.HasOne("APZ_BACKEND.Entities.ItemTaking", "ItemTaking")
